package javarealworldchallenges.threads.ThreadPoolSingleThread_ConcurrentLinkedQueue;
...
public class AssemblyLine {
    ...
    private static final Logger logger = Logger.getLogger(javarealworldchallenges.threads.ThreadPoolSingleThread_TransferQueue.AssemblyLine.class.getName());
